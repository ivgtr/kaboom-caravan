...
| `veh_player_rig_parts_v003`       | Rotating wheel and 3 exhaust stages | OpenAI built-in `image_gen`                  | 1254 master / 1024 runtime | v003    | accepted / integrated | `GameRenderer` |
...
- Player locomotion no longer uses the v002 `move` pose. The stable idle chassis
  is combined with the v003 rotating wheel and exhaust parts at runtime.
