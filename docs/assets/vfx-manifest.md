...
| `vfx_parry_swipe_ready_v002`     | Active parry counter-swipe         | OpenAI built-in `image_gen` | 1254 master / 1024 runtime         | v002    | accepted / integrated | `GameRenderer` |
| `vfx_parry_deflect_success_v002` | Perfect-parry upward deflection    | OpenAI built-in `image_gen` | 1254 master / 1024 runtime         | v002    | accepted / integrated | `GameRenderer` |
...
Parry deflection v002 prompt source:
[`parry_deflect_vfx_prompts_v002.md`](../../artifacts/vfx/prompts/parry_deflect_vfx_prompts_v002.md)
...
- Parry: a forward counter-swipe followed by an upward-right deflection; each
  pose is a standalone asset, so artwork cannot leak across sprite cells
...
- Parry ready Desktop: `artifacts/vfx/review/parry_ready_1184x689_v002.png`
- Parry ready Mobile Landscape: `artifacts/vfx/review/parry_ready_844x390_v002.png`
- Parry success Desktop: `artifacts/vfx/review/parry_success_1184x689_v002.png`
- Parry success Mobile Landscape: `artifacts/vfx/review/parry_success_844x390_v002.png`
