...
| ---- | -------- | ------ | -------- | -------- | --------------- | ------------------- | ----- |
| 1    | 103.867s | 100    | 659.436  | 155/32   | 82.9/17.1%      | 11/0/11             | 11    |
| 42   | 113.483s | 100    | 662.474  | 168/30   | 84.8/15.2%      | 11/0/11             | 11    |
| 2026 | 121.917s | 95     | 657.111  | 193/34   | 85.0/15.0%      | 12/1/11             | 11    |
...
| 10     | 13.350s | 13.350s | 13.417s   |

## Findings for User Playtest

- 3 Seedすべてが全10戦を完走し、Boss戦は13.35〜13.42秒。パリィ成功時の反撃と即時Cooldown回復が討伐時間へ反映される。
...
- 最低HPは95〜100。固定戦略は攻撃到達を正確に予測するため、手動プレイではパリィ失敗時の圧力を重点確認する。
- 各Runで11回のパリィが成功し、敵弾命中は0〜1発。成功時Cooldown即時回復により連続迎撃が成立する。
- 自動戦闘時間は104〜122秒。人間操作でも目標10〜20分へ届かない場合は、HPの一括増加ではなくEncounter数またはWave構造を再検討する。
