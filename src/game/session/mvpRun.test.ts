...
// These fixed values include BREAK pacing, its damage effects and subsequent loot effects.
const EXPECTED_RUN_BASELINES: Readonly<Record<number, ExpectedRunBaseline>> = {
  '1': {
    ...
    finalBuild: {
      ...
      moduleIds: ['radar', 'ammo-box', 'magnetic-armor', 'shield-generator'],
      coreId: 'counter',
    },
  },
  '42': {
    elapsedTicks: 5502,
    encounterTicks: [447, 495, 643, 512, 542, 527, 570, 513, 513, 740],
    endingHitPoints: [100, 100, 100, 100, 100, 100, 100, 100, 115, 125],
    forwardDistances: [
      69.845, 70, 70, 59.778, 70, 66.018, 63.735, 69.675, 68.183, 62.6,
    ],
    primaryShots: 136,
    secondaryShots: 35,
    enemyProjectiles: [9, 1, 8],
    attacksParried: 8,
    rewardIds: [
  ...
  '2026': {
    elapsedTicks: 5125,
    encounterTicks: [447, 495, 480, 512, 530, 528, 504, 499, 498, 632],
    endingHitPoints: [100, 100, 100, 100, 100, 100, 100, 100, 100, 100],
    forwardDistances: [
      69.845, 70, 64.8, 59.778, 70, 66.018, 68, 69.4, 68.395, 62.6,
    ],
    primaryShots: 116,
    secondaryShots: 35,
